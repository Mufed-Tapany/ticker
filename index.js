(function () {
    initTicker("news", "newsBottom");

    function initTicker(top, bottom) {
        var newsContainer = document.getElementById(top);
        var newsContainerBottom = document.getElementById(bottom);
